...
@JsType(isNative=true,name="Uint16Array")
...
Uint16Array filter(FilterCallback callbackfn);
@JsMethod(name="filter")
Uint16Array filter(FilterCallback callbackfn, java.lang.Object thisArg);
@JsMethod(name="find")
...
@JsMethod(name="map")
Uint16Array map(MapCallback callbackfn);
@JsMethod(name="map")
Uint16Array map(MapCallback callbackfn, java.lang.Object thisArg);
...
Uint16Array sort();
@JsMethod(name="sort")
Uint16Array sort(SortCallback compareFn);
...
{
java.lang.Object apply(double value, double index, Uint16Array array);
}
@JsFunction public static interface FindIndexCallback
{
boolean apply(double value, double index, Uint16Array obj);
}
@JsFunction public static interface SomeCallback
{
boolean apply(double value, double index, Uint16Array array);
}
@JsFunction public static interface MapCallback
{
double apply(double value, double index, Uint16Array array);
}
@JsFunction public static interface ReduceRightCallback1<U> 
{
U apply(U previousValue, double currentValue, double currentIndex, Uint16Array array);
}
@JsFunction public static interface ReduceRightCallback0
{
double apply(double previousValue, double currentValue, double currentIndex, Uint16Array array);
}
...
{
void apply(double value, double index, Uint16Array array);
}
...
@JsOverlay
public static Uint16Array getPrototype(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win) {
  java.lang.Object obj = com.user00.domjnate.util.Js.getMember(_win, "Uint16Array", com.user00.domjnate.util.EmptyInterface.class);
  return com.user00.domjnate.util.Js.getMember(obj, "prototype", Uint16Array.class);
}
@JsOverlay
...
@JsOverlay
public static Uint16Array of(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, double... items) {
  return com.user00.domjnate.util.Js.callStaticMethod(_win, "Uint16Array", "of", Uint16Array.class, items);
}
@JsOverlay
public static Uint16Array from(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, ArrayLike<Double> arrayLike) {
  return com.user00.domjnate.util.Js.callStaticMethod(_win, "Uint16Array", "from", Uint16Array.class, arrayLike);
}
@JsOverlay
public static Uint16Array from(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, ArrayLike<Double> arrayLike, FromCallback mapfn) {
  return com.user00.domjnate.util.Js.callStaticMethod(_win, "Uint16Array", "from", Uint16Array.class, arrayLike, mapfn);
}
@JsOverlay
public static Uint16Array from(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, ArrayLike<Double> arrayLike, FromCallback mapfn, java.lang.Object thisArg) {
  return com.user00.domjnate.util.Js.callStaticMethod(_win, "Uint16Array", "from", Uint16Array.class, arrayLike, mapfn, thisArg);
}
@JsOverlay
public static Uint16Array _new(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, double length) {
  java.lang.Object constructor = com.user00.domjnate.util.Js.getConstructor(_win, "Uint16Array");
  return com.user00.domjnate.util.Js.construct(_win, constructor, Uint16Array.class, length);
}
@JsOverlay
public static Uint16Array _new(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, java.lang.Object arrayOrArrayBuffer) {
  java.lang.Object constructor = com.user00.domjnate.util.Js.getConstructor(_win, "Uint16Array");
  return com.user00.domjnate.util.Js.construct(_win, constructor, Uint16Array.class, arrayOrArrayBuffer);
}
@JsOverlay
public static Uint16Array _new(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, ArrayLike<Double> arrayOrArrayBuffer) {
  java.lang.Object constructor = com.user00.domjnate.util.Js.getConstructor(_win, "Uint16Array");
  return com.user00.domjnate.util.Js.construct(_win, constructor, Uint16Array.class, arrayOrArrayBuffer);
}
@JsOverlay
public static Uint16Array _new(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, java.lang.Object buffer, double byteOffset) {
  java.lang.Object constructor = com.user00.domjnate.util.Js.getConstructor(_win, "Uint16Array");
  return com.user00.domjnate.util.Js.construct(_win, constructor, Uint16Array.class, buffer, byteOffset);
}
@JsOverlay
public static Uint16Array _new(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, java.lang.Object buffer, double byteOffset, double length) {
  java.lang.Object constructor = com.user00.domjnate.util.Js.getConstructor(_win, "Uint16Array");
  return com.user00.domjnate.util.Js.construct(_win, constructor, Uint16Array.class, buffer, byteOffset, length);
}
}
