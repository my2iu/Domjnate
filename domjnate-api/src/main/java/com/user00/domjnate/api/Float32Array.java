...
@JsType(isNative=true,name="Float32Array")
...
Float32Array filter(FilterCallback callbackfn);
@JsMethod(name="filter")
Float32Array filter(FilterCallback callbackfn, java.lang.Object thisArg);
@JsMethod(name="find")
...
@JsMethod(name="map")
Float32Array map(MapCallback callbackfn);
@JsMethod(name="map")
Float32Array map(MapCallback callbackfn, java.lang.Object thisArg);
...
Float32Array sort();
@JsMethod(name="sort")
Float32Array sort(SortCallback compareFn);
...
{
java.lang.Object apply(double value, double index, Float32Array array);
}
@JsFunction public static interface FindIndexCallback
{
boolean apply(double value, double index, Float32Array obj);
}
@JsFunction public static interface SomeCallback
{
boolean apply(double value, double index, Float32Array array);
}
@JsFunction public static interface MapCallback
{
double apply(double value, double index, Float32Array array);
}
@JsFunction public static interface ReduceRightCallback1<U> 
{
U apply(U previousValue, double currentValue, double currentIndex, Float32Array array);
}
@JsFunction public static interface ReduceRightCallback0
{
double apply(double previousValue, double currentValue, double currentIndex, Float32Array array);
}
...
{
void apply(double value, double index, Float32Array array);
}
...
@JsOverlay
public static Float32Array getPrototype(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win) {
  java.lang.Object obj = com.user00.domjnate.util.Js.getMember(_win, "Float32Array", com.user00.domjnate.util.EmptyInterface.class);
  return com.user00.domjnate.util.Js.getMember(obj, "prototype", Float32Array.class);
}
@JsOverlay
...
@JsOverlay
public static Float32Array of(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, double... items) {
  return com.user00.domjnate.util.Js.callStaticMethod(_win, "Float32Array", "of", Float32Array.class, items);
}
@JsOverlay
public static Float32Array from(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, ArrayLike<Double> arrayLike) {
  return com.user00.domjnate.util.Js.callStaticMethod(_win, "Float32Array", "from", Float32Array.class, arrayLike);
}
@JsOverlay
public static Float32Array from(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, ArrayLike<Double> arrayLike, FromCallback mapfn) {
  return com.user00.domjnate.util.Js.callStaticMethod(_win, "Float32Array", "from", Float32Array.class, arrayLike, mapfn);
}
@JsOverlay
public static Float32Array from(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, ArrayLike<Double> arrayLike, FromCallback mapfn, java.lang.Object thisArg) {
  return com.user00.domjnate.util.Js.callStaticMethod(_win, "Float32Array", "from", Float32Array.class, arrayLike, mapfn, thisArg);
}
@JsOverlay
public static Float32Array _new(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, double length) {
  java.lang.Object constructor = com.user00.domjnate.util.Js.getConstructor(_win, "Float32Array");
  return com.user00.domjnate.util.Js.construct(_win, constructor, Float32Array.class, length);
}
@JsOverlay
public static Float32Array _new(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, java.lang.Object arrayOrArrayBuffer) {
  java.lang.Object constructor = com.user00.domjnate.util.Js.getConstructor(_win, "Float32Array");
  return com.user00.domjnate.util.Js.construct(_win, constructor, Float32Array.class, arrayOrArrayBuffer);
}
@JsOverlay
public static Float32Array _new(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, ArrayLike<Double> arrayOrArrayBuffer) {
  java.lang.Object constructor = com.user00.domjnate.util.Js.getConstructor(_win, "Float32Array");
  return com.user00.domjnate.util.Js.construct(_win, constructor, Float32Array.class, arrayOrArrayBuffer);
}
@JsOverlay
public static Float32Array _new(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, java.lang.Object buffer, double byteOffset) {
  java.lang.Object constructor = com.user00.domjnate.util.Js.getConstructor(_win, "Float32Array");
  return com.user00.domjnate.util.Js.construct(_win, constructor, Float32Array.class, buffer, byteOffset);
}
@JsOverlay
public static Float32Array _new(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, java.lang.Object buffer, double byteOffset, double length) {
  java.lang.Object constructor = com.user00.domjnate.util.Js.getConstructor(_win, "Float32Array");
  return com.user00.domjnate.util.Js.construct(_win, constructor, Float32Array.class, buffer, byteOffset, length);
}
}
