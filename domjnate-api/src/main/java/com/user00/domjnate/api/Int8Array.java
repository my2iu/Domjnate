...
@JsType(isNative=true,name="Int8Array")
...
Int8Array filter(FilterCallback callbackfn);
@JsMethod(name="filter")
Int8Array filter(FilterCallback callbackfn, java.lang.Object thisArg);
@JsMethod(name="find")
...
@JsMethod(name="map")
Int8Array map(MapCallback callbackfn);
@JsMethod(name="map")
Int8Array map(MapCallback callbackfn, java.lang.Object thisArg);
...
Int8Array sort();
@JsMethod(name="sort")
Int8Array sort(SortCallback compareFn);
...
{
java.lang.Object apply(double value, double index, Int8Array array);
}
@JsFunction public static interface FindIndexCallback
{
boolean apply(double value, double index, Int8Array obj);
}
@JsFunction public static interface SomeCallback
{
boolean apply(double value, double index, Int8Array array);
}
@JsFunction public static interface MapCallback
{
double apply(double value, double index, Int8Array array);
}
@JsFunction public static interface ReduceRightCallback1<U> 
{
U apply(U previousValue, double currentValue, double currentIndex, Int8Array array);
}
@JsFunction public static interface ReduceRightCallback0
{
double apply(double previousValue, double currentValue, double currentIndex, Int8Array array);
}
...
{
void apply(double value, double index, Int8Array array);
}
...
@JsOverlay
public static Int8Array getPrototype(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win) {
  java.lang.Object obj = com.user00.domjnate.util.Js.getMember(_win, "Int8Array", com.user00.domjnate.util.EmptyInterface.class);
  return com.user00.domjnate.util.Js.getMember(obj, "prototype", Int8Array.class);
}
@JsOverlay
...
@JsOverlay
public static Int8Array of(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, double... items) {
  return com.user00.domjnate.util.Js.callStaticMethod(_win, "Int8Array", "of", Int8Array.class, items);
}
@JsOverlay
public static Int8Array from(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, ArrayLike<Double> arrayLike) {
  return com.user00.domjnate.util.Js.callStaticMethod(_win, "Int8Array", "from", Int8Array.class, arrayLike);
}
@JsOverlay
public static Int8Array from(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, ArrayLike<Double> arrayLike, FromCallback mapfn) {
  return com.user00.domjnate.util.Js.callStaticMethod(_win, "Int8Array", "from", Int8Array.class, arrayLike, mapfn);
}
@JsOverlay
public static Int8Array from(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, ArrayLike<Double> arrayLike, FromCallback mapfn, java.lang.Object thisArg) {
  return com.user00.domjnate.util.Js.callStaticMethod(_win, "Int8Array", "from", Int8Array.class, arrayLike, mapfn, thisArg);
}
@JsOverlay
public static Int8Array _new(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, double length) {
  java.lang.Object constructor = com.user00.domjnate.util.Js.getConstructor(_win, "Int8Array");
  return com.user00.domjnate.util.Js.construct(_win, constructor, Int8Array.class, length);
}
@JsOverlay
public static Int8Array _new(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, java.lang.Object arrayOrArrayBuffer) {
  java.lang.Object constructor = com.user00.domjnate.util.Js.getConstructor(_win, "Int8Array");
  return com.user00.domjnate.util.Js.construct(_win, constructor, Int8Array.class, arrayOrArrayBuffer);
}
@JsOverlay
public static Int8Array _new(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, ArrayLike<Double> arrayOrArrayBuffer) {
  java.lang.Object constructor = com.user00.domjnate.util.Js.getConstructor(_win, "Int8Array");
  return com.user00.domjnate.util.Js.construct(_win, constructor, Int8Array.class, arrayOrArrayBuffer);
}
@JsOverlay
public static Int8Array _new(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, java.lang.Object buffer, double byteOffset) {
  java.lang.Object constructor = com.user00.domjnate.util.Js.getConstructor(_win, "Int8Array");
  return com.user00.domjnate.util.Js.construct(_win, constructor, Int8Array.class, buffer, byteOffset);
}
@JsOverlay
public static Int8Array _new(com.user00.domjnate.api.WindowOrWorkerGlobalScope _win, java.lang.Object buffer, double byteOffset, double length) {
  java.lang.Object constructor = com.user00.domjnate.util.Js.getConstructor(_win, "Int8Array");
  return com.user00.domjnate.util.Js.construct(_win, constructor, Int8Array.class, buffer, byteOffset, length);
}
}
